...
namespace IG.kafka.roledeleted
{
    ...
    /// <summary>Represents the removal of an existing security role.</summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "9.10.42.0 (Newtonsoft.Json v11.0.0.0)")]
    public partial class RoleDeleted : @event
    {
        ...
        public static RoleDeleted FromJson(string data)
        {
            return Newtonsoft.Json.JsonConvert.DeserializeObject<RoleDeleted>(data);
        }
