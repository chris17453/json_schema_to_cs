...
namespace IG.kafka.candidatearchived
{
    ...
    /// <summary>A candidate has been archived.</summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "9.10.42.0 (Newtonsoft.Json v11.0.0.0)")]
    public partial class CandidateArchived : @event
    {
        ...
        public static CandidateArchived FromJson(string data)
        {
            return Newtonsoft.Json.JsonConvert.DeserializeObject<CandidateArchived>(data);
        }
