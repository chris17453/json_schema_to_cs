...
namespace IG.kafka.candidateoffbcl
{
    ...
    /// <summary>A contractor has been termed.</summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "9.10.42.0 (Newtonsoft.Json v11.0.0.0)")]
    public partial class CandidateOffBcl : @event
    {
        ...
        public static CandidateOffBcl FromJson(string data)
        {
            return Newtonsoft.Json.JsonConvert.DeserializeObject<CandidateOffBcl>(data);
        }
