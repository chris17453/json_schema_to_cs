...
namespace IG.kafka.regionupdated
{
    ...
    /// <summary>Represents a bulk update of an existing region.</summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "9.10.42.0 (Newtonsoft.Json v11.0.0.0)")]
    public partial class RegionUpdated : @event
    {
        ...
        public static RegionUpdated FromJson(string data)
        {
            return Newtonsoft.Json.JsonConvert.DeserializeObject<RegionUpdated>(data);
        }
