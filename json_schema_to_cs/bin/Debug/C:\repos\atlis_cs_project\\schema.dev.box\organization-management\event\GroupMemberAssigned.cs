...
namespace IG.kafka.groupmemberassigned
{
    ...
    /// <summary>Indicates that a group has a new member.</summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "9.10.42.0 (Newtonsoft.Json v11.0.0.0)")]
    public partial class GroupMemberAssigned : @event
    {
        ...
        public static GroupMemberAssigned FromJson(string data)
        {
            return Newtonsoft.Json.JsonConvert.DeserializeObject<GroupMemberAssigned>(data);
        }
