...
namespace IG.kafka.employeehired
{
    ...
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "9.10.42.0 (Newtonsoft.Json v11.0.0.0)")]
    public partial class EmployeeHired : @event
    {
        ...
        public static EmployeeHired FromJson(string data)
        {
            return Newtonsoft.Json.JsonConvert.DeserializeObject<EmployeeHired>(data);
        }
    ...
    {
        /// <summary>Effective date of employment.</summary>
