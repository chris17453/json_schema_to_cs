...
namespace IG.kafka.internalesfstatuschanged
{
    ...
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "9.10.42.0 (Newtonsoft.Json v11.0.0.0)")]
    public partial class InternalESFStatusChanged : @event
    {
        ...
        public static InternalESFStatusChanged FromJson(string data)
        {
            return Newtonsoft.Json.JsonConvert.DeserializeObject<InternalESFStatusChanged>(data);
        }
