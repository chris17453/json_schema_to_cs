...
namespace IG.kafka.roleexcluded
{
    ...
    /// <summary>Indicates that a security role no longer subsumes the granted authorities provided by another role.</summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "9.10.42.0 (Newtonsoft.Json v11.0.0.0)")]
    public partial class RoleExcluded : @event
    {
        ...
        public static RoleExcluded FromJson(string data)
        {
            return Newtonsoft.Json.JsonConvert.DeserializeObject<RoleExcluded>(data);
        }
