...
namespace IG.kafka.rolepermissiongranted
{
    ...
    /// <summary>Indicates that a security role obtained new permissions.</summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "9.10.42.0 (Newtonsoft.Json v11.0.0.0)")]
    public partial class RolePermissionGranted : @event
    {
        ...
        public static RolePermissionGranted FromJson(string data)
        {
            return Newtonsoft.Json.JsonConvert.DeserializeObject<RolePermissionGranted>(data);
        }
