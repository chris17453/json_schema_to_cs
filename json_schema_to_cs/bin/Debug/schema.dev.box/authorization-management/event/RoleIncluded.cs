...
namespace IG.kafka.roleincluded
{
    ...
    /// <summary>Indicates that a security role subsumes the granted authorities provided by another role.</summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "9.10.42.0 (Newtonsoft.Json v11.0.0.0)")]
    public partial class RoleIncluded : @event
    {
        ...
        public static RoleIncluded FromJson(string data)
        {
            return Newtonsoft.Json.JsonConvert.DeserializeObject<RoleIncluded>(data);
        }
