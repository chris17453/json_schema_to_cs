...
namespace IG.kafka.departmentdeleted
{
    ...
    /// <summary>Represents the removal of an existing department.</summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "9.10.42.0 (Newtonsoft.Json v11.0.0.0)")]
    public partial class DepartmentDeleted : @event
    {
        ...
        public static DepartmentDeleted FromJson(string data)
        {
            return Newtonsoft.Json.JsonConvert.DeserializeObject<DepartmentDeleted>(data);
        }
