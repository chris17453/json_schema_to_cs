...
namespace IG.kafka.groupcreated
{
    ...
    /// <summary>Represents the creation of a new group.</summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "9.10.42.0 (Newtonsoft.Json v11.0.0.0)")]
    public partial class GroupCreated : @event
    {
        ...
        public static GroupCreated FromJson(string data)
        {
            return Newtonsoft.Json.JsonConvert.DeserializeObject<GroupCreated>(data);
        }
