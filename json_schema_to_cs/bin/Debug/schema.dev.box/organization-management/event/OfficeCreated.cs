...
namespace IG.kafka.officecreated
{
    ...
    /// <summary>Represents the creation of a new office.</summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "9.10.42.0 (Newtonsoft.Json v11.0.0.0)")]
    public partial class OfficeCreated : @event
    {
        ...
        public static OfficeCreated FromJson(string data)
        {
            return Newtonsoft.Json.JsonConvert.DeserializeObject<OfficeCreated>(data);
        }
