...
namespace IG.kafka.groupmemberremoved
{
    ...
    /// <summary>Indicates that a group has lost a member.</summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "9.10.42.0 (Newtonsoft.Json v11.0.0.0)")]
    public partial class GroupMemberRemoved : @event
    {
        ...
        public static GroupMemberRemoved FromJson(string data)
        {
            return Newtonsoft.Json.JsonConvert.DeserializeObject<GroupMemberRemoved>(data);
        }
