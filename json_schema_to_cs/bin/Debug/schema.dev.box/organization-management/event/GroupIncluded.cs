...
namespace IG.kafka.groupincluded
{
    ...
    /// <summary>Indicates that a group subsumes the members of another group.</summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "9.10.42.0 (Newtonsoft.Json v11.0.0.0)")]
    public partial class GroupIncluded : @event
    {
        ...
        public static GroupIncluded FromJson(string data)
        {
            return Newtonsoft.Json.JsonConvert.DeserializeObject<GroupIncluded>(data);
        }
