...
namespace IG.kafka.groupdeleted
{
    ...
    /// <summary>Represents the removal of an existing group.</summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "9.10.42.0 (Newtonsoft.Json v11.0.0.0)")]
    public partial class GroupDeleted : @event
    {
        ...
        public static GroupDeleted FromJson(string data)
        {
            return Newtonsoft.Json.JsonConvert.DeserializeObject<GroupDeleted>(data);
        }
