...
namespace IG.kafka.candidatesubmitted
{
    ...
    /// <summary>A candidate has been submitted.</summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "9.10.42.0 (Newtonsoft.Json v11.0.0.0)")]
    public partial class CandidateSubmitted : @event
    {
        ...
        public static CandidateSubmitted FromJson(string data)
        {
            return Newtonsoft.Json.JsonConvert.DeserializeObject<CandidateSubmitted>(data);
        }
    ...
    public partial class payload 
    {
        ...
        [Newtonsoft.Json.JsonProperty("jobCategoryId", Required = Newtonsoft.Json.Required.Always)]
        ...
        /// <summary>from -> super_account column in req_customer. TODO: This should be renamed 'code' instead of 'id' for standardization</summary>
        [Newtonsoft.Json.JsonProperty("clientId", Required = Newtonsoft.Json.Required.Always)]
        [System.ComponentModel.DataAnnotations.Required(AllowEmptyStrings = true)]
        public string clientId { get; set; }
    
        /// <summary>From super_account/req_customer. TODO: This should be a 'client' object</summary>
        ...
        [Newtonsoft.Json.JsonProperty("enteredByName", Required = Newtonsoft.Json.Required.Always)]
        [System.ComponentModel.DataAnnotations.Required(AllowEmptyStrings = true)]
        ...
        [Newtonsoft.Json.JsonProperty("referralType", Required = Newtonsoft.Json.Required.Always)]
        [System.ComponentModel.DataAnnotations.Required(AllowEmptyStrings = true)]
