...
namespace IG.kafka.submittalstatuschanged
{
    ...
    /// <summary>A Submittal Status has changed.</summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "9.10.42.0 (Newtonsoft.Json v11.0.0.0)")]
    public partial class SubmittalStatusChanged : @event
    {
        ...
        public static SubmittalStatusChanged FromJson(string data)
        {
            return Newtonsoft.Json.JsonConvert.DeserializeObject<SubmittalStatusChanged>(data);
        }
    ...
    public partial class payload 
    {
        ...
        [System.ComponentModel.DataAnnotations.Required(AllowEmptyStrings = true)]
        [System.ComponentModel.DataAnnotations.RegularExpression(@"^[A-Z0-9]{1}$")]
