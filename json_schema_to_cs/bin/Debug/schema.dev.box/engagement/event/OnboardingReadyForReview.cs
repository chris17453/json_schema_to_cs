...
namespace IG.kafka.onboardingreadyforreview
{
    ...
    /// <summary>Onboarding Ready for Review</summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "9.10.42.0 (Newtonsoft.Json v11.0.0.0)")]
    public partial class OnboardingReadyForReview : @event
    {
        ...
        public static OnboardingReadyForReview FromJson(string data)
        {
            return Newtonsoft.Json.JsonConvert.DeserializeObject<OnboardingReadyForReview>(data);
        }
