...
namespace IG.kafka.onboardinginitiated
{
    ...
    /// <summary>Onboarding Initiated</summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "9.10.42.0 (Newtonsoft.Json v11.0.0.0)")]
    public partial class OnboardingInitiated : @event
    {
        ...
        public static OnboardingInitiated FromJson(string data)
        {
            return Newtonsoft.Json.JsonConvert.DeserializeObject<OnboardingInitiated>(data);
        }
