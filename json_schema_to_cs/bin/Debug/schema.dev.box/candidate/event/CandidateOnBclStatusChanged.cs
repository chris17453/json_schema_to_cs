...
namespace IG.kafka.candidateonbclstatuschanged
{
    ...
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "9.10.42.0 (Newtonsoft.Json v11.0.0.0)")]
    public partial class CandidateOnBclStatusChanged : @event
    {
        ...
        public static CandidateOnBclStatusChanged FromJson(string data)
        {
            return Newtonsoft.Json.JsonConvert.DeserializeObject<CandidateOnBclStatusChanged>(data);
        }
