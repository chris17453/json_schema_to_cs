...
namespace IG.kafka.entitydeleted
{
    ...
    /// <summary>Represents the removal of an existing entity.</summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "9.10.42.0 (Newtonsoft.Json v11.0.0.0)")]
    public partial class EntityDeleted : @event
    {
        ...
        public static EntityDeleted FromJson(string data)
        {
            return Newtonsoft.Json.JsonConvert.DeserializeObject<EntityDeleted>(data);
        }
