...
namespace IG.kafka.officedeleted
{
    ...
    /// <summary>Represents the removal of an existing office.</summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "9.10.42.0 (Newtonsoft.Json v11.0.0.0)")]
    public partial class OfficeDeleted : @event
    {
        ...
        public static OfficeDeleted FromJson(string data)
        {
            return Newtonsoft.Json.JsonConvert.DeserializeObject<OfficeDeleted>(data);
        }
