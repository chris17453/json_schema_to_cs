...
namespace IG.kafka.employeeterminated
{
    ...
    /// <summary>An employee who has been hired at a particular office.</summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "9.10.42.0 (Newtonsoft.Json v11.0.0.0)")]
    public partial class EmployeeTerminated : @event
    {
        ...
        public static EmployeeTerminated FromJson(string data)
        {
            return Newtonsoft.Json.JsonConvert.DeserializeObject<EmployeeTerminated>(data);
        }
    ...
    {
        /// <summary>Effective date of termination.</summary>
        [Newtonsoft.Json.JsonProperty("effective", Required = Newtonsoft.Json.Required.Always)]
        [System.ComponentModel.DataAnnotations.Required(AllowEmptyStrings = true)]
        ...
        /// <summary>TODO: should really be 'office' for standardization. must fix in comtrak code.</summary>
