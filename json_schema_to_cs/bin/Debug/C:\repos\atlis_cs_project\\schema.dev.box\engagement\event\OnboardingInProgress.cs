...
namespace IG.kafka.onboardinginprogress
{
    ...
    /// <summary>Onboarding In Progress</summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "9.10.42.0 (Newtonsoft.Json v11.0.0.0)")]
    public partial class OnboardingInProgress : @event
    {
        ...
        public static OnboardingInProgress FromJson(string data)
        {
            return Newtonsoft.Json.JsonConvert.DeserializeObject<OnboardingInProgress>(data);
        }
