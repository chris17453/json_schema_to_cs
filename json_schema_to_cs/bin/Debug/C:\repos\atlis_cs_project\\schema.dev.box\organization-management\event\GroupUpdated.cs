...
namespace IG.kafka.groupupdated
{
    ...
    /// <summary>A group is a named set of members with similar projects and goals.</summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "9.10.42.0 (Newtonsoft.Json v11.0.0.0)")]
    ...
    /// <summary>Represents a bulk update of an existing group.</summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "9.10.42.0 (Newtonsoft.Json v11.0.0.0)")]
    public partial class GroupUpdated : @event
    {
        ...
        public static GroupUpdated FromJson(string data)
        {
            return Newtonsoft.Json.JsonConvert.DeserializeObject<GroupUpdated>(data);
        }
