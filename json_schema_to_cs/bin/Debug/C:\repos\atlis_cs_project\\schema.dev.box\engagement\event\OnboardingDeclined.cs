...
namespace IG.kafka.onboardingdeclined
{
    ...
    /// <summary>Onboarding Declined</summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "9.10.42.0 (Newtonsoft.Json v11.0.0.0)")]
    public partial class OnboardingDeclined : @event
    {
        ...
        public static OnboardingDeclined FromJson(string data)
        {
            return Newtonsoft.Json.JsonConvert.DeserializeObject<OnboardingDeclined>(data);
        }
