...
namespace IG.kafka.usertypecreated
{
    ...
    /// <summary>A new work position/title entered.</summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "9.10.42.0 (Newtonsoft.Json v11.0.0.0)")]
    public partial class UsertypeCreated : @event
    {
        ...
        public static UsertypeCreated FromJson(string data)
        {
            return Newtonsoft.Json.JsonConvert.DeserializeObject<UsertypeCreated>(data);
        }
