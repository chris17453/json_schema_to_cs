...
namespace IG.kafka.regioncreated
{
    ...
    /// <summary>Represents the creation of a new region.</summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "9.10.42.0 (Newtonsoft.Json v11.0.0.0)")]
    public partial class RegionCreated : @event
    {
        ...
        public static RegionCreated FromJson(string data)
        {
            return Newtonsoft.Json.JsonConvert.DeserializeObject<RegionCreated>(data);
        }
