...
namespace IG.kafka.groupexcluded
{
    ...
    /// <summary>Indicates that a group no longer subsumes the members in another group.</summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "9.10.42.0 (Newtonsoft.Json v11.0.0.0)")]
    public partial class GroupExcluded : @event
    {
        ...
        public static GroupExcluded FromJson(string data)
        {
            return Newtonsoft.Json.JsonConvert.DeserializeObject<GroupExcluded>(data);
        }
