...
namespace IG.kafka.rolememberremoved
{
    ...
    /// <summary>Indicates that a security role has lost a member.</summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "9.10.42.0 (Newtonsoft.Json v11.0.0.0)")]
    public partial class RoleMemberRemoved : @event
    {
        ...
        public static RoleMemberRemoved FromJson(string data)
        {
            return Newtonsoft.Json.JsonConvert.DeserializeObject<RoleMemberRemoved>(data);
        }
