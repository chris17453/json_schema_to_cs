...
namespace IG.kafka.departmentcreated
{
    ...
    /// <summary>Represents the creation of a new department.</summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "9.10.42.0 (Newtonsoft.Json v11.0.0.0)")]
    public partial class DepartmentCreated : @event
    {
        ...
        public static DepartmentCreated FromJson(string data)
        {
            return Newtonsoft.Json.JsonConvert.DeserializeObject<DepartmentCreated>(data);
        }
