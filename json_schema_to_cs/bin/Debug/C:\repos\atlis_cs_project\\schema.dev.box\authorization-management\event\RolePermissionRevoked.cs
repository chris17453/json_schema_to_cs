...
namespace IG.kafka.rolepermissionrevoked
{
    ...
    /// <summary>Indicates that a security role lost some permissions.</summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "9.10.42.0 (Newtonsoft.Json v11.0.0.0)")]
    public partial class RolePermissionRevoked : @event
    {
        ...
        public static RolePermissionRevoked FromJson(string data)
        {
            return Newtonsoft.Json.JsonConvert.DeserializeObject<RolePermissionRevoked>(data);
        }
