...
namespace IG.kafka.accountcreated
{
    ...
    /// <summary>Represents the creation of a new account.</summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "9.10.42.0 (Newtonsoft.Json v11.0.0.0)")]
    public partial class AccountCreated : @event
    {
        ...
        public static AccountCreated FromJson(string data)
        {
            return Newtonsoft.Json.JsonConvert.DeserializeObject<AccountCreated>(data);
        }
