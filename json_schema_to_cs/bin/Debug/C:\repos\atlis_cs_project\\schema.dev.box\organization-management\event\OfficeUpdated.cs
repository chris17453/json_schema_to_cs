...
namespace IG.kafka.officeupdated
{
    ...
    public partial class region 
    {
        ...
        [Newtonsoft.Json.JsonProperty("regionLeaders", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public System.Collections.ObjectModel.ObservableCollection<employee> regionLeaders { get; set; } = new System.Collections.ObjectModel.ObservableCollection<employee>();
    ...
    public partial class office 
    {
        ...
        [System.ComponentModel.DataAnnotations.Required(AllowEmptyStrings = true)]
        [Newtonsoft.Json.JsonConverter(typeof(Newtonsoft.Json.Converters.StringEnumConverter))]
        public officeTimeZone timeZone { get; set; }
    
        [Newtonsoft.Json.JsonProperty("defaultCurrency", Required = Newtonsoft.Json.Required.Always)]
        [System.ComponentModel.DataAnnotations.Required(AllowEmptyStrings = true)]
        [Newtonsoft.Json.JsonConverter(typeof(Newtonsoft.Json.Converters.StringEnumConverter))]
        ...
        [Newtonsoft.Json.JsonProperty("officePhone", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string officePhone { get; set; }
    
        [Newtonsoft.Json.JsonProperty("pitExtension", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string pitExtension { get; set; }
    
        [Newtonsoft.Json.JsonProperty("fax1", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string fax1 { get; set; }
    
        [Newtonsoft.Json.JsonProperty("fax2", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        ...
        [Newtonsoft.Json.JsonProperty("annualBase", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public double annualBase { get; set; }
    
        [Newtonsoft.Json.JsonProperty("hrSpecialist", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public employee hrSpecialist { get; set; } = new employee();
    
        [Newtonsoft.Json.JsonProperty("payrollSpecialist", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public employee payrollSpecialist { get; set; } = new employee();
    
        [Newtonsoft.Json.JsonProperty("timesheetSpecialist", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public employee timesheetSpecialist { get; set; } = new employee();
    
        [Newtonsoft.Json.JsonProperty("officeLeaders", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public System.Collections.ObjectModel.ObservableCollection<employee> officeLeaders { get; set; } = new System.Collections.ObjectModel.ObservableCollection<employee>();
    ...
    /// <summary>Represents a bulk update of an existing office.</summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "9.10.42.0 (Newtonsoft.Json v11.0.0.0)")]
    public partial class OfficeUpdated : @event
    {
        ...
        public static OfficeUpdated FromJson(string data)
        {
            return Newtonsoft.Json.JsonConvert.DeserializeObject<OfficeUpdated>(data);
        }
