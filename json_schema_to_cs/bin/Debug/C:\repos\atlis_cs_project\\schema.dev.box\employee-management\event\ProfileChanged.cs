...
namespace IG.kafka.profilechanged
{
    ...
    /// <summary>The change in a user's position at an office.</summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "9.10.42.0 (Newtonsoft.Json v11.0.0.0)")]
    public partial class ProfileChanged : @event
    {
        ...
        public static ProfileChanged FromJson(string data)
        {
            return Newtonsoft.Json.JsonConvert.DeserializeObject<ProfileChanged>(data);
        }
