...
namespace IG.kafka.rolecreated
{
    ...
    /// <summary>Represents the creation of a new security role.</summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "9.10.42.0 (Newtonsoft.Json v11.0.0.0)")]
    public partial class RoleCreated : @event
    {
        ...
        public static RoleCreated FromJson(string data)
        {
            return Newtonsoft.Json.JsonConvert.DeserializeObject<RoleCreated>(data);
        }
    ...
    public partial class payload 
    {
        ...
        [Newtonsoft.Json.JsonProperty("authorities", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public System.Collections.ObjectModel.ObservableCollection<string> authorities { get; set; } = new System.Collections.ObjectModel.ObservableCollection<string>();
        ...
        public System.Collections.ObjectModel.ObservableCollection<string> members { get; set; } = new System.Collections.ObjectModel.ObservableCollection<string>();
