...
namespace IG.kafka.regiondeleted
{
    ...
    /// <summary>Represents the removal of an existing region.</summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "9.10.42.0 (Newtonsoft.Json v11.0.0.0)")]
    public partial class RegionDeleted : @event
    {
        ...
        public static RegionDeleted FromJson(string data)
        {
            return Newtonsoft.Json.JsonConvert.DeserializeObject<RegionDeleted>(data);
        }
