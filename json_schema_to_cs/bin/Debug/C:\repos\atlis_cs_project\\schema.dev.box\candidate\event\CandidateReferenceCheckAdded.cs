...
namespace IG.kafka.candidatereferencecheckadded
{
    ...
    /// <summary>A candidate reference check been added.</summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "9.10.42.0 (Newtonsoft.Json v11.0.0.0)")]
    public partial class CandidateReferenceCheckAdded : @event
    {
        [Newtonsoft.Json.JsonProperty("candidateId", Required = Newtonsoft.Json.Required.Always)]
        [System.ComponentModel.DataAnnotations.Required(AllowEmptyStrings = true)]
        public string candidateId { get; set; }
    
        [Newtonsoft.Json.JsonProperty("referenceCheck", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public object referenceCheck { get; set; } = new object();
        ...
        public static CandidateReferenceCheckAdded FromJson(string data)
        {
            return Newtonsoft.Json.JsonConvert.DeserializeObject<CandidateReferenceCheckAdded>(data);
        }
