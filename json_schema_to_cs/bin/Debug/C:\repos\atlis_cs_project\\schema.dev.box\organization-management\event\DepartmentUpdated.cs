...
namespace IG.kafka.departmentupdated
{
    ...
    /// <summary>A department represents an operative team of employees.</summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "9.10.42.0 (Newtonsoft.Json v11.0.0.0)")]
    public partial class department 
    {
        ...
        {
            return Newtonsoft.Json.JsonConvert.DeserializeObject<department>(data);
        }
    
    }
    
    /// <summary>Represents a bulk update of an existing department.</summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "9.10.42.0 (Newtonsoft.Json v11.0.0.0)")]
    public partial class DepartmentUpdated : @event
    {
        ...
        public static DepartmentUpdated FromJson(string data)
        {
            return Newtonsoft.Json.JsonConvert.DeserializeObject<DepartmentUpdated>(data);
        }
