...
namespace IG.kafka.onboardingcancelled
{
    ...
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "9.10.42.0 (Newtonsoft.Json v11.0.0.0)")]
    public partial class OnboardingCancelled : @event
    {
        ...
        public static OnboardingCancelled FromJson(string data)
        {
            return Newtonsoft.Json.JsonConvert.DeserializeObject<OnboardingCancelled>(data);
        }
